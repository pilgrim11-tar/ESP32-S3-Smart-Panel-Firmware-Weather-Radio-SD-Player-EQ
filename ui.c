...
///////////////////// FUNCTIONS ////////////////////
static uint32_t s_swipe_nav_last_ms = 0;

static int ui_can_handle_swipe(lv_obj_t *expected_screen)
{
    if (!expected_screen || lv_scr_act() != expected_screen)
    {
        return 0;
    }

    const uint32_t now = lv_tick_get();
    if ((uint32_t)(now - s_swipe_nav_last_ms) < 320U)
    {
        return 0;
    }

    s_swipe_nav_last_ms = now;
    return 1;
}
...
if ( !ui_can_handle_swipe( ui_Screen1 ) ) { return; }
...
if ( !ui_can_handle_swipe( ui_Screen1 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_Screen13, LV_SCR_LOAD_ANIM_NONE, 0, 0, &ui_Screen13_screen_init);
}
}
void ui_event_Image11( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
if ( !ui_can_handle_swipe( ui_Screen10 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_Screen11, LV_SCR_LOAD_ANIM_NONE, 0, 0, &ui_Screen11_screen_init);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
if ( !ui_can_handle_swipe( ui_Screen10 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
...
void ui_event_Screen11( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
if ( !ui_can_handle_swipe( ui_Screen11 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_Screen12, LV_SCR_LOAD_ANIM_NONE, 0, 0, &ui_Screen12_screen_init);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
if ( !ui_can_handle_swipe( ui_Screen11 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
...
void ui_event_Screen12( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
if ( !ui_can_handle_swipe( ui_Screen12 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_Screen13, LV_SCR_LOAD_ANIM_NONE, 0, 0, &ui_Screen13_screen_init);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
...
void ui_event_Screen13( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
if ( !ui_can_handle_swipe( ui_Screen13 ) ) { return; }
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_Screen12, LV_SCR_LOAD_ANIM_NONE, 0, 0, &ui_Screen12_screen_init);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
...
lv_theme_t *theme = lv_theme_default_init(dispp, lv_palette_main(LV_PALETTE_BLUE), lv_color_make(66, 84, 133), true, LV_FONT_DEFAULT);
