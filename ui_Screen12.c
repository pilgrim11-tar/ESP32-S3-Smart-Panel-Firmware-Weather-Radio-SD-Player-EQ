...
lv_img_set_src(ui_Image40, &ui_img_s4_mode2_png_no_text);
...
lv_img_set_src(ui_Image41, &ui_img_s4_mode1_png_no_text);
...
lv_img_set_src(ui_Image64, &ui_img_s4_card1_png);
...
lv_obj_set_style_border_width(ui_Button3, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_shadow_width(ui_Button3, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_shadow_width(ui_Button3, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_outline_width(ui_Button3, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_outline_width(ui_Button3, 0, LV_PART_MAIN | LV_STATE_PRESSED);

ui_Image65 = lv_img_create(ui_Screen12);
lv_img_set_src(ui_Image65, &ui_img_s4_card2_png);
...
lv_obj_remove_style_all(ui_Button4);
...
lv_obj_set_style_bg_opa(ui_Button4, 0, LV_PART_MAIN| LV_STATE_PRESSED);
lv_obj_set_style_border_width(ui_Button4, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_border_width(ui_Button4, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_shadow_width(ui_Button4, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_shadow_width(ui_Button4, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_outline_width(ui_Button4, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_outline_width(ui_Button4, 0, LV_PART_MAIN | LV_STATE_PRESSED);

ui_Image66 = lv_img_create(ui_Screen12);
lv_img_set_src(ui_Image66, &ui_img_s4_card3_png);
...
lv_obj_set_style_bg_opa(ui_Button5, 0, LV_PART_MAIN| LV_STATE_PRESSED);
lv_obj_set_style_border_width(ui_Button5, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_border_width(ui_Button5, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_shadow_width(ui_Button5, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_shadow_width(ui_Button5, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_outline_width(ui_Button5, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_outline_width(ui_Button5, 0, LV_PART_MAIN | LV_STATE_PRESSED);

ui_Button6 = lv_btn_create(ui_Screen12);
lv_obj_remove_style_all(ui_Button6);
...
lv_obj_set_style_border_width(ui_Button6, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_shadow_width(ui_Button6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_shadow_width(ui_Button6, 0, LV_PART_MAIN | LV_STATE_PRESSED);
lv_obj_set_style_outline_width(ui_Button6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
lv_obj_set_style_outline_width(ui_Button6, 0, LV_PART_MAIN | LV_STATE_PRESSED);

ui_Image67 = lv_img_create(ui_Screen12);
lv_img_set_src(ui_Image67, &ui_img_s4_card4_png);
