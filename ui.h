...
LV_IMG_DECLARE( ui_img_s4_mode2_png_no_text);   // mode2_full_no_text.png
LV_IMG_DECLARE( ui_img_s4_mode1_png_no_text);   // mode1_full_no_text.png
...
LV_IMG_DECLARE( ui_img_s4_card1_png);
LV_IMG_DECLARE( ui_img_s4_card2_png);
LV_IMG_DECLARE( ui_img_s4_card3_png);
